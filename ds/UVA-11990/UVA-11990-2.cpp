...
struct Block {
    ...
    ll query_less(ll x, ll y, ll v) {
        ...
        if (p == q) {
            ...
            rep(i, p + 1, q - 1) {
                ll temp = lower_bound(b[i].begin(), b[i].end(), v) - b[i].begin();
                ans += temp;
            }
        }
        return ans;
    ...
    ll query_greater(ll x, ll y, ll v) {
        ...
        if (p == q) {
            ...
            rep(i, l[q], y) ans += (a[i] != -1 && a[i] > v);
            rep(i, p + 1, q - 1) {
                ll temp = b[i].end() - upper_bound(b[i].begin(), b[i].end(), v);
                ans += temp;
            }
        }
        return ans;
    ...
    void remove(ll x) {
        ll p = pos[rnk[x]];
        auto temp = lower_bound(b[p].begin(), b[p].end(), x);
        b[p].erase(temp);
        a[rnk[x]] = -1; 
    }
